export const mockProducts = [
  { id: 1, name: "Cashmere Overcoat", category: "Outerwear", price: 1200, stock: 15, status: "In Stock" },
  { id: 2, name: "Merino Wool Sweater", category: "Knitwear", price: 350, stock: 8, status: "Low Stock" },
  { id: 3, name: "Tailored Trousers", category: "Trousers", price: 280, stock: 22, status: "In Stock" },
  { id: 4, name: "Oxford Shirt", category: "Shirts", price: 180, stock: 0, status: "Out of Stock" },
  { id: 5, name: "Leather Loafers", category: "Footwear", price: 420, stock: 12, status: "In Stock" },
]
